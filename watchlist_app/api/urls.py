...
from .views import Watch_list,Watch_details,Review_list,Review_Detail,MovieReview_list,MovieReview_Create,StreamPlatView,User_Review, Watchlistviewtest
...
urlpatterns = [
    ...
    path('movie/list/',Watchlistviewtest.as_view(), name='Watchlist'),
    ...
    path('review/<str:username>/',User_Review.as_view(), name='User_Review'),    
